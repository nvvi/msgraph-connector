...
' #txt
Cs0 f0 outParameterDecl '<msgraph.connector.NewMail mail> result;' #txt
...
>Proto Cs0 .type com.axonivy.connector.office365.msgraph.demo.WriteMail.WriteMailData #txt
