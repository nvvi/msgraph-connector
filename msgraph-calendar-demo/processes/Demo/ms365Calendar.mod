...
mo0 f20 dialogId msgraph.calendar.demo.Events #txt
...
mo0 f11 dialogId msgraph.calendar.demo.Events #txt
...
' #txt
mo0 f11 488 170 112 44 -21 -7 #rect
mo0 f12 440 192 488 192 #arcP
mo0 f8 600 192 657 192 #arcP
mo0 f13 dialogId msgraph.calendar.demo.CreateEvent #txt
...
' #txt
mo0 f13 160 170 112 44 -38 -7 #rect
mo0 f14 111 192 160 192 #arcP
mo0 f7 272 192 328 192 #arcP
>Proto mo0 .type msgraph.calendar.demo.CalendarDemo #txt
