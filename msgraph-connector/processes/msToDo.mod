...
mo0 f7 inParamDecl '<msgraph.connector.NewToDo task> param;' #txt
...
' #txt
mo0 f7 callSignature createNewTask(msgraph.connector.NewToDo) #txt
mo0 f7 @CG|tags CONNECTOR #txt
...
>Proto mo0 .type msgraph.connector.ToDoData #txt
