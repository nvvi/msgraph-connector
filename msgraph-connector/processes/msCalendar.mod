...
mr0 f9 inParamDecl '<msgraph.connector.NewEvent evt> param;' #txt
...
' #txt
mr0 f9 callSignature createMeeting(msgraph.connector.NewEvent) #txt
mr0 f9 @CG|tags CONNECTOR #txt
...
>Proto mr0 .type msgraph.connector.CalendarData #txt
